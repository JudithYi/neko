...
int main(int argc, char *argv[]){
    ...
    */
    ...
    if(!rank){
        ...
        int_vec1_count = 1;
        int_vec1_start = static_cast<std::size_t>(len_nek+rank);
    }
    /*
    ...
    */
    ...
    if(!rank){
        ...
        double_vec1_count = 1;
        double_vec1_start = static_cast<std::size_t>(len_nek+rank);
    }
    /*
    ...
    */
    ...
    nelgv = vINT_CONST2[8];
    nelgt = vINT_CONST2[9];
    iostep = vINT_CONST2[10];
    dim = 3;
    if(!vINT_CONST2[11]) dim = 2;
    /*
    lx1 = vINT_CONST[0];
    ly1 = vINT_CONST[1];
    lz1 = vINT_CONST[2];
    ...
    //std::cout << "iostep is " << vINT_CONST[10] << std::endl;
    //iostep = 1;
    dim = 3;
    ...
    */
    ...
    simulation_start = vDOUBLE_CONST2[0];
    //simulation_dt = 0.5;
    simulation_dt = vDOUBLE_CONST2[1];
